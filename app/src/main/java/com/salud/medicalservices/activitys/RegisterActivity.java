...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText edt_mail, edt_nombres, edt_appaterno, edt_apmaterno;
    Spinner spinner_document;
    String dataSpinner;
    TextView edt_documento;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_apmaterno = findViewById(R.id.edt_apmaterno);
        ...
        getSupportActionBar().setTitle(R.string.title_toolbar_register);
        ...
        mCreateAccountBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userMaterno = edt_apmaterno.getText().toString().trim();
